 ...
 * @author user
 */
public class JFrmVistaProducto extends javax.swing.JFrame {

    /**
     * Creates new form JFrmVistaProducto
     */
    public JFrmVistaProducto() {
        initComponents();
        mostrar("");
    ...
    private void tablalistadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMousePressed
        ...
        if (evt.getClickCount()==2) {
            ...
            JFrmConsumo.txtidproducto.setText(cod);
            JFrmConsumo.txtproducto.setText(valor1);
            JFrmConsumo.txtprecio_venta.setText(valor2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrmVistaProducto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrmVistaProducto().setVisible(true);
            }
        });
    }
