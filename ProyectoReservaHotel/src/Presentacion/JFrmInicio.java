...
public class JFrmInicio extends javax.swing.JFrame {
    ...
    public JFrmInicio() {
        initComponents();
        this.setExtendedState(JFrmInicio.MAXIMIZED_BOTH);
        this.setTitle("Sistema de Reserva de Habitaciones y Gestión de Ventas - LucoDeveloper");
    }
    ...
    private void cutMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cutMenuItemActionPerformed
        ...
        JFrmHabitacion form = new JFrmHabitacion();
        escritorio.add(form);
        form.toFront();
    ...
    private void copyMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_copyMenuItemActionPerformed
        // TODO add your handling code here:
        JFrmProducto form = new JFrmProducto();
        escritorio.add(form);
        form.toFront();
        form.setVisible(true);
    ...
    private void aboutMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aboutMenuItemActionPerformed
        // TODO add your handling code here:
        JFrmCliente form = new JFrmCliente();
        escritorio.add(form);
        form.toFront();
        form.setVisible(true);
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        // TODO add your handling code here:
        JFrmTrabajador form = new JFrmTrabajador();
        escritorio.add(form);
        form.toFront();
        form.setVisible(true);        
    ...
    /*MENU RESERVAS Y CONSUMOS*/
    private void contentMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_contentMenuItemActionPerformed
        // TODO add your handling code here:
        JFrmReserva form = new JFrmReserva();
        escritorio.add(form);
        form.toFront();
        form.setVisible(true);
        JFrmReserva.txtidtrabajador.setText(lblidpersona.getText());
        JFrmReserva.txttrabajador.setText(lblnombre.getText() + " " + lblapaterno.getText());
        JFrmReserva.idusuario = Integer.parseInt(lblidpersona.getText());
