 ...
 * @author user
 */
public class JFrmVistaHabitacion extends javax.swing.JFrame {

    /**
     * Creates new form JFrmVistaHabitacion
     */
    public JFrmVistaHabitacion() {
        initComponents();
        mostrar("");
    ...
    private void tablalistadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMousePressed
        ...
        if (evt.getClickCount() == 2){
            ...
            JFrmReserva.txtidhabitacion.setText(cod);
            JFrmReserva.txtnumero.setText(valor);
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrmVistaHabitacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrmVistaHabitacion().setVisible(true);
            }
        });
    }
